...
async function main() {
  ...
  assertDenied({ mode: 'remote', accountId: 'wrong-account' }, { expectedRemoteD1Id: PILOT_RESOURCE_NAMES.d1Id })
  assertDenied({ mode: 'remote', pagesProjectId: 'wrong-pages-id' }, { expectedRemoteD1Id: PILOT_RESOURCE_NAMES.d1Id })
  assertDenied({ mode: 'remote' }, { expectedRemoteD1Id: PILOT_RESOURCE_NAMES.d1Id })
