  ...
  return (
    <div className="admin-manager">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        <h3 style={{ margin: 0, color: '#fff' }}>Cargos Profissionais</h3>
        {!editing && (
          <button onClick={() => setEditing({ id: '', code: '', name: '', description: '', department_id: '', is_active: true })} style={{ background: '#c6ff38', color: '#000', padding: '8px 16px', borderRadius: '6px', border: 'none', fontWeight: 'bold', cursor: 'pointer' }}>
            + Novo Cargo
          </button>
        )}
      </div>
